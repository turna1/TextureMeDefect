...
[Use this notebook with your own OpenAI API key to generate synthetic dataset to Fine-Tune GPT models](https://github.com/turna1/DefectTwin/blob/main/defect_texture__fine_tunellm_with_synthetic_data.ipynb)
